...
Production instances are used for production, pre-production, or staging environments with fixed domains. Production instances offer the strongest security and performance guarantees. Review our [Instances / Environments](/docs/deployments/environments) doc to learn more about the differences.
